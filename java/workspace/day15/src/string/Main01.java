...
//		int str2_pos = str2.indexOf("a",2);
		...
		// 6. 문자열의 앞뒤 공백 제거
		String input = " enjou   java programming  ";
		...
		// %d : 정수, %s : 문자, %3s : 문자열을 3자리로 맞춰서 출력. 맞지않으면 빈칸 공백출력, (%03s와 같은 형식은 사용불가)
		// %f : float형 소수, 
		// %3d : 숫자를 3자리로 맞춰서 출력. 자리수가 맞지않으면 공백, %03d : 자릿수가 맞지않으면 앞에 0을출력
